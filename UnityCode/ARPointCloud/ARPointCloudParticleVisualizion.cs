...
namespace UnityEngine.XR.ARFoundation
{
    ...
    //[HelpURL(HelpUrls.ApiWithNamespace + nameof(ARPointCloudParticleVisualizion) + ".html")]
    public sealed class ARPointCloudParticleVisualizion : MonoBehaviour
    {
        ...
        public static ARPointCloud m_PointCloud;

        public static ParticleSystem m_ParticleSystem;

        public static ParticleSystem.Particle[] m_Particles;

        public static int m_NumParticles;

        public static int t_numParticle;

        public static List<Vector3> s_Vertices = new List<Vector3>();
    }
}
